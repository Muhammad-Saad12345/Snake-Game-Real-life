...
#Game Title
pygame.display.set_caption("Snake By Python With Saad")
...
#GameOverScreen
           ...
           text_screen("Muhammad Saad your Score is: " + str(score) + "  Highscore: "+str(highscore),  snakegreen, 5, 5)
